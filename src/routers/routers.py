...
from schemas.schemas import ConverterInput, ConverterOutput
...
async def async_converter_router(body: ConverterInput,from_currency: str = Path(max_length=3, regex='^[A-Z]{3}$')):
